...
console.log("UC7-a TotalWage using ForEach: "+totalWage);

function totalWagwUsingReduce(total,dailyEmpWage)
{
    return total + dailyEmpWage;
}
console.log("UC7-a TotalWage using reduce: "+empDailyWageArr.reduce(totalWagwUsingReduce,0));
let daycount = 0;
...
console.log("UC7-b Day along with dailyWage -> "+mapDayWithDailyWage);
...
console.log("UC7-c FullTime working days -> "+fullTimeDays);
console.log("UC7-d First occurance of Fulltime workday -> "+mapDayWithDailyWage.find(getFullTimeDays));
console.log("UC7-e Check All elements are Full time working days -> "+fullTimeDays.every(getFullTimeDays));
function getPartTimeDays(dailyEmpWage)
{
    return dailyEmpWage.includes("80");
}
console.log("UC7-f Check if any elements are part time working days -> "+mapDayWithDailyWage.some(getPartTimeDays));
...
console.log("UC7-g Number of actual working days -> "+ empDailyWageArr.reduce(getTotalWorkingDays,0));
